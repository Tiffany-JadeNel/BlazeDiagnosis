...
This is a remote internship. Meetings will be arranged informally based on availability because some students are part-time and some are full-time.

You are expected to communicate clearly about:
...
Never commit passwords, API keys, access tokens, personal credentials, `.env` files, database URLs, or private client information.
